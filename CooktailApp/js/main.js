...
function getDrink() {
    ///code for removing every li that has been created in the previous iteration!!!///
    ...
    fetch (url) 
        ...
        .then(data => {
            ...
            //this part of the code do the carousel, when you fished all the drinks you got the fist one agin an then the second etc.///
            ...
            }///Why in the first interaction count is 6 ?
            if (count>=arrDrinks.length) {
                count =0
